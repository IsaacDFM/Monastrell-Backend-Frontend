    ...
    <div className="flex flex-col items-center">
      ...
      <div className="flex gap-4">
        ...
        <button className="inline-grid place-items-center border align-middle select-none font-sans font-medium text-center transition-all duration-300 ease-in disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none text-sm min-w-[38px] min-h-[38px] rounded-md shadow-sm hover:shadow-md border-[#24292e] bg-[#24292e] text-white hover:border-[#24292e] hover:bg-[#24292e] hover:brightness-110">
          <svg width="1.5em" height="1.5em" stroke-width="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="currentColor" className="h-4 w-4 stroke-2">
      ...
      <p className="text-center mt-4 text-sm text-gray-700">
        ...
        <a href="https://www.creative-tim.com/david-ui/docs/html/icon-button" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">
